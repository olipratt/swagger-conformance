Welcome to swagger-conformance's documentation!
===============================================

This is the documentation for ``swaggerconformance`` package available on `PyPI <https://pypi.python.org/pypi/swagger-conformance>`__ and `Github <https://github.com/olipratt/swagger-conformance>`__.
